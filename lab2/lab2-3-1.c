//******************************************************************************
//  Filename: lab2-3-1.c
//  Send status of red LED over UART when pressing button S2
...
//  - Use the timer routine to toggle RED LED
//  - Send the status of red LED (LED1) over UART when pressing button S2
//******************************************************************************
#include <msp430.h>
